...
const PAGE_SIZE = 24;
export default function Directory({ resources, locale, topicCards, savedOnly = false, wikiDocuments = [] }: { resources: Resource[]; locale: Locale; topicCards?: ReactNode; savedOnly?: boolean; wikiDocuments?: WikiListDocument[] }) {
  ...
  return <div className={`directory-shell ${sidebarOpen ? '' : 'sidebar-collapsed'}`}>
    ...
    <div className="directory-main">
      ...
      {!savedOnly && <WikiSearchResults documents={wikiDocuments} query={query} locale={locale}/>}
